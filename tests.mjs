...
test('v10 immediate dashboard health and fixed GitHub target',()=>{
  ...
  assert.match(worker,/VERSION='\d+\.\d+\.\d+'/);
...
test('v15 weighted data quality dashboard is present',()=>{
  ...
  assert.match(index,/const VERSION='\d+\.\d+\.\d+'/);
